...
namespace Hinata.Internals
{
    internal static class HtmlUtility
    {
        ...
        private static readonly string[] NotUrlEncodeAttributes = new[] {"style", "class"};
        ...
        public static string SanitizeHtml(string source)
        {
            ...
            {
                var nodes = allNodes.DescendantsAndSelf().Where(n => n.Name == tag.Key);
